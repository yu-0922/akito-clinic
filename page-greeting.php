    ...
    <div class="main slide-in">
      ...
      <div class="greeting-contents">
        <article>
          ...
          <p class="speech">あきと内科胃腸科では、患者様に寄り添った最善の医療を目指しています。<br>同じような症状でも、原因や程度など人それぞれ異なるため、検査・診療を丁寧に行い、患者様１人１人にとって最善の治療を行います。また、検査結果等を患者様にも分かりやすく説明し、ご自身の病気や治療方針をしっかり理解してもらうことで、より安心して治療を受けていただけるよう心掛けております。</p>
