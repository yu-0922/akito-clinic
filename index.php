  ...
  <body>
    ...
    <div class="box">
      <div class="doctor_pic">
        <img class="doctor" src="<?php echo get_stylesheet_directory_uri(); ?>/images/doctor.png" alt="院長の写真">
      </div>
